...
def get_dicts_from_hypergraph(hypergraph):
    """"
    Convert an HGX hypergraph to an edge to nodes dict H and node to edges dict E
    Paramenters:
        hypergraph: HGX hypergraph
    Returns:
        H: a dictionary with edge indices as keys and the nodes they contain as values
        E: a dictionary with node indices as keys and the edges that contain them as values
